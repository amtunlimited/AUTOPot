!Utility subroutines to be used with POTLIB2001 interface libraries
!Copyright (C) 2003 R. J. Duchovic, Y. L. Volobuev, G. C. Lynch, A. W. Jasper, D. G. Truhlar, T. C. Allison, A. F. Wagner, B. C. Garrett, J. Espinosa-García, and J. C. Corchado

!These subroutines are free software: you can redistribute it and/or modify
